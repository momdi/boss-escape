...
const I18N_TEXT = {
  ko: {
    ...
    notMetRare: '{cs}를 담아 두면 만날 확률이 올라가요.',
    mVisit: '방문',
    mVisitN: '{n}번',
    mAff: '친밀도',
    mLikes: '좋아하는 것',
    ...
    guideSub: '할 일을 하나씩 끝내고 길냥이를 모아요',
    g1a: '할 일을 완료하면', g1b: '{c}를 한 알씩 얻어요.',
    g2a: '★ 별표 할 일을 끝내면', g2b: '{cs}가 생겨요. 하루 {n}개까지 정할 수 있고, 상점에서 밥그릇과 선물을 살 때 씁니다.',
    g3a: '하루 {n}개를 넘기면', g3b: '{cs}를 덤으로 받아요.',
    g4a: '밥그릇을 한 번 클릭하면', g4b: '밥그릇에 사료를 담아요.',
    g4wa: '밥그릇을 누르면', g4wb: '밥그릇에 사료를 담아요.',
    g5a: '밥그릇을 두 번 클릭하면', g5b: '할 일 창이 열려요. 창을 닫아도 냥이는 계속 찾아옵니다.',
    g6a: '이제 기다리면 돼요.', g6b: '사료 냄새를 맡고 길냥이가 하나둘 찾아옵니다. {cs}를 담아 두면 귀한 냥이가 올 확률이 올라가요.',
    g7a: '고양이를 우클릭하면', g7b: '사진을 찍어 도감에 남기거나 선물을 줄 수 있어요. 사진을 찍으면 이름도 지어 줍니다.',
    g7wa: '냥이가 오면', g7wb: '카메라로 찍어 도감에 남기고 이름을 지어 주세요.',
    g8a: '밥그릇과 고양이는', g8b: '끌어서 원하는 자리로 옮길 수 있어요. 고양이를 클릭하면 폴짝 뛰며 야옹합니다.',
    g9a: '중요일정에 날짜를 넣으면', g9b: 'D-day가 표시돼요. 날짜가 없으면 그냥 잊지 않게 적어 두는 메모입니다.',
    gotIt: '알겠어요',
  ...
  en: {
    ...
    g1a: 'Finish a to-do', g1b: 'and you earn one {c}.',
    g2a: '★ Starred to-dos', g2b: 'give you a {cs}. Up to {n} a day — spend them in the shop on bowls and gifts.',
    g3a: 'Finish {n} in a day', g3b: 'for a bonus {cs}.',
    g4a: 'Click the bowl once', g4b: 'to fill it with food.',
    g4wa: 'Tap the bowl', g4wb: 'to fill it with food.',
    g5a: 'Double-click the bowl', g5b: 'to open the to-do window. Cats keep visiting even when it is closed.',
    g6a: 'Now just wait.', g6b: 'Stray cats will smell the food and drop by. A {cs} in the bowl brings rarer cats.',
    g7a: 'Right-click a cat', g7b: 'to take a photo for your album or give a gift. Photographing lets you name it.',
    g7wa: 'When a cat arrives', g7wb: 'photograph it for your album and give it a name.',
    g8a: 'The bowl and the cats', g8b: 'can be dragged anywhere. Click a cat and it hops and meows.',
    g9a: 'Add a date to an important item', g9b: 'and it shows a countdown.',
