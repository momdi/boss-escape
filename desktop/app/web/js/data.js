...
const CATS = [
  ...
  {
    id: 'berry', species: '딸기', species_en: 'Berry', rarity: 'legend',
    desc: '어디서 얻었는지 모를 딸기 옷을 입고 다닌다. 벗기려 하면 도망간다.',
    desc_en: 'Wears a strawberry suit from who-knows-where. Runs if you try to take it off.',
